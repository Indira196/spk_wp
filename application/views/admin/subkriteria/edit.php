                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="all-form-element-inner">
                                                            <form action="<?php echo base_url('admin/subkriteria/edit/'.$subkriteria['id_sub']); ?>" method="post">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                           <div class="chosen-select-single">
                                                                                <select name="id_kriteria" class="select2_demo_2 form-control" >
                                                                                    ...
                                                                                    <option value="<?php echo $kriteria['id_kriteria'] ?>" <?php if($subkriteria['id_kriteria']==$kriteria['id_kriteria']){ echo "selected"; } ?>>
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <input type="text" name="keterangan" class="form-control" value="<?php echo $subkriteria['keterangan'] ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                 <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <input type="text" name="nilai_bobot" class="form-control" value="<?php echo $subkriteria['nilai_bobot'] ?>">
