                                                            ...
                                                            <form action="<?php echo base_url('admin/dashboard/locations') ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <img src="<?php echo base_url('assets/upload/image/frame_maps.png') ?>" style="max-width:800px; height:auto;"><br>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                            <label class="login2 pull-right pull-right-pro">Paste Google Maps Frame Disini : </label>
                                                                        </div>
                                                                        <div class="col-lg-9">
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <iframe src="<?php echo $site['google_maps'];?>" width="400" height="700" frameborder="0" style="border:0" allowfullscreen></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group-inner">
