                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="all-form-element-inner">
                                                            <form action="<?php echo base_url('admin/anggrek/create') ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <input type="text" name="anggrek_nama" class="form-control" value="<?php echo set_value('anggrek_nama') ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <input type="text" name="nama_latin" class="form-control" value="<?php echo set_value('nama_latin') ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group-inner">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <div class="tinymce-area">
                                                                                <textarea id="summernote" name="gambar_deskripsi" class="form-control">
                                                                                    <?php echo set_value('gambar_deskripsi') ?>
                                                                                </textarea>  
                                                                            </div>
                                                                        </div>
                                                                    </div>
